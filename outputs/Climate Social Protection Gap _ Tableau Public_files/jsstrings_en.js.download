...
(function(w) {
  var s = {
    ...
    AccessibilityDrilldownActivated: "Drill-down is activated on ",
    AccessibilityDrilldownWarningTabLevel: "This is a drill-down viz. Mouse and keyboard will drill down on interaction.",
    AccessibilityFieldDataTypeBin: "bin",
    AccessibilityFieldDataTypeBoolean: "boolean",
    AccessibilityFieldDataTypeCluster: "cluster",
    AccessibilityFieldDataTypeCubeAttribute: "attribute",
    AccessibilityFieldDataTypeCubeLevel: "level",
    AccessibilityFieldDataTypeCubeLevelWithNumber: "level {0}",
    AccessibilityFieldDataTypeDate: "date",
    AccessibilityFieldDataTypeDateTime: "date and time",
    AccessibilityFieldDataTypeGeographical: "geographical",
    AccessibilityFieldDataTypeGroup: "group",
    AccessibilityFieldDataTypeHierarchy: "hierarchy",
    AccessibilityFieldDataTypeImageRole: "image role",
    AccessibilityFieldDataTypeNumber: "number",
    AccessibilityFieldDataTypeSet: "set",
    AccessibilityFieldDataTypeString: "string",
    AccessibilityFieldDataTypeUserFilterSet: "user filter set",
    AccessibilityFieldTypeFolder: "folder",
    AccessibilityFieldTypeObject: "table",
    AccessibilityFieldTypeTable: "table",
    ...
    AccessibilityMarkLevelSpaceKeyToSelectAndDrilldown: "Press Space to drill down and select this mark.",
    ...
    AccessibilitySceneMarginElementLevelCtrlEnterSortIndicator: "Press Ctrl + Enter to focus sort indicator.",
    ...
    AccessibilitySceneMarginLevelSpaceKeyToSelectAndDrilldown: "Press Space to drill down and select this {0}.",
    ...
    AccessibilitySheetTabsMenuButton: "Sheet Tabs",
    ...
    AccessibilitySortIndicatorFocused: " Sort Indicator. Press Space to {0}. Press Escape to go back to the {1}.",
    AccessibilitySortIndicatorSortClearedActivation: "Clear Sort",
    AccessibilityTabOrderLevelEscape: "Press Escape to remove selections.",
    AccessibilityTabOrderLevelPressEnterOrTab: "Press Enter to navigate the visualization. Press Tab to navigate to the next object.",
    ...
    AccessibilityVizInTooltip: "There is a viz in the tooltip.",
    ...
    AccordionHeaderSrMarksLayerHidden: "This Marks layer is hidden in the view.",
    AccordionHeaderSrMarksLayerVisible: "This Marks layer is visible in the view.",
    AccordionHeaderSrMarksTabTitle: "{0}. Marks tab.",
    AccordionHeaderSrMarksTabsNavigation: "Use the arrow keys to navigate between Marks tabs.",
    AddALayerLineOne: "Add a",
    AddALayerLineTwo: "Marks Layer",
    ...
    AuthCardSrCollapsedFieldsHiddenPlural: "Collapsed with {0} fields hidden.",
    AuthCardSrCollapsedFieldsHiddenSingular: "Collapsed with 1 field hidden.",
    AuthCardSrCollapsedFieldsHiddenZero: "Collapsed with no fields hidden.",
    AuthCardSrPressSpaceCollapse: "Press Space key to collapse the card.",
    AuthCardSrPressSpaceExpand: "Press Space key to expand the card.",
    AuthCardSrTitle: "{0} card.",
    ...
    AuthSaveLabelShowTabsUnchecked: "Show sheets as tabs checkbox not checked to check press the spacebar",
    ...
    CategoricalLegendTitleColor: "Color legend for {0}",
    CategoricalLegendTitleMap: "Map legend for {0}",
    CategoricalLegendTitleShape: "Shape legend for {0}",
    CategoricalLegendTitleSize: "Size legend for {0}",
    ...
    ContextMenuAddTo: "Add to",
    ContextMenuAddToOptionDataPane: "Data Pane",
    ContextMenuAddToOptionSheet: "Sheet (Automatically)",
    ContextMenuCopyDrag: "Copy Drag to...",
    ContextMenuCopyTo: "Copy to",
    ContextMenuMoveTo: "Move to",
    ContextMenuNormalDrag: "Drag to...",
    ContextMenuRightClickDrag: "Right-Click Drag to...",
    ContextMenuShiftDrag: "Shift Drag to...",
    ...
    EncodingButtonNavigationInstructions: "Press Space or Enter to open the encoding editor. Use the arrow keys to navigate between encoding cards.",
    EncodingCard: "{0} encoding card",
    EncodingShelfTitle: "Encoding",
    ...
    ExtensionDeniedByUserAuthoringDashboard: "To grant approval for a Dashboard Extension, select Reset Permissions from the More Options context menu.",
    ExtensionDeniedByUserBase: "This extension requires permission to run.",
    ExtensionDeniedByUserViewing: "To grant approval, refresh the page and select OK when prompted.",
    ExtensionDeniedByUserViz: "To grant approval for a Viz Extension, refresh the page and select OK when prompted.",
    ...
    JuneNarrow: "J",
    JuneShort: "Jun",
    KeyboardDragDropCanceledMessage: "Drop canceled.",
    KeyboardDragDropCompletedMessage: "Item dropped in {0}.",
    KeyboardDragDropFailedMessage: "Drop failed. Drop area {0} didn\'t accept the current item.",
    KeyboardDragDropFirstLocation: "You\'re at the first drop location. Press Spacebar to drop, or use the Right or Down Arrow keys to move forward.",
    KeyboardDragDropLastLocation: "You\'re at the last drop location. Press Spacebar to drop, or use the Left or Up Arrow keys to move backward.",
    KeyboardDragDropLocation: "Drop location: {0}.",
    KeyboardDragDropNavigationInstructions: "Moved to drop area {0}. Use Arrow keys to navigate between drop locations. Press Spacebar to drop. Press Escape to cancel.",
    KeyboardDragDropNavigationInstructionsForSimpleArea: "Moved to drop area {0}. Press Spacebar to drop. Press Escape to cancel.",
    LastPublished: "Last Published",
    LayoutPaneArrangeSectionTitle: "Arrange",
    LayoutPaneBackgroundColorTitle: "Background",
    LayoutPaneBorderButtonTitle: "Border",
    LayoutPaneCornerRadiusAllCornersEqual: "All corners equal",
    LayoutPaneCornerRadiusAllCornersEqualLocked: "All corners equal (on)",
    LayoutPaneCornerRadiusAllCornersEqualUnlocked: "All corners equal (off)",
    LayoutPaneCornerRadiusBottomLeft: "Bottom Left",
    LayoutPaneCornerRadiusBottomRight: "Bottom Right",
    LayoutPaneCornerRadiusButtonTitle: "Corner Radius",
    LayoutPaneCornerRadiusTopLeft: "Top Left",
    LayoutPaneCornerRadiusTopRight: "Top Right",
    ...
    LayoutPaneSpacingCornerRadiusButtonLabel: "Corner Radius: TopLeft {0}, TopRight {1}, BottomLeft {2}, BottomRight {3}",
    ...
    Pill: "{0} pill",
    PillDividerAtEnd: "Insertion point at end",
    PillDividerBeforePill: "Insertion point before the {0} pill",
    PillNavInstructionPressCtrlEnter: "Press Ctrl+Enter to open the encoding type dropdown.",
    PillNavInstructionPressEnter: "Press Enter to open the context menu.",
    PillNavInstructionPressEsc: "Press Esc to return to the {0} shelf.",
    PillNavInstructionUseArrowKeys: "Use the Arrow keys to navigate pills.",
    ...
    QuantitativeQuickfilterEndDateAriaLabel: "The selected end date is {0}. Press Enter to edit.",
    QuantitativeQuickfilterLowerBoundAriaLabel: "Current lower bound is {0}. Press Enter to edit.",
    QuantitativeQuickfilterLowerBoundDisabledAriaLabel: "Current lower bound is {0}. Not editable.",
    QuantitativeQuickfilterRangeAriaLabel: "{0}. Range of {1} to {2} selected out of range of {3} to {4}.",
    QuantitativeQuickfilterStartDateAriaLabel: "The selected start date is {0}. Press Enter to edit.",
    QuantitativeQuickfilterUpperBoundAriaLabel: "Current upper bound is {0}. Press Enter to edit.",
    QuantitativeQuickfilterUpperBoundDisabledAriaLabel: "Current upper bound is {0}. Not editable.",
    QuickFilterAll: "(All)",
    ...
    ShelfAriaLabelPlural: "{0} shelf, containing {1} pills",
    ShelfAriaLabelSingular: "{0} shelf, containing 1 pill",
    ShelfAriaLabelZero: "{0} shelf, containing 0 pills",
    ShelfNavInstructionPressEnter: "Press Enter to navigate to the pills on the shelf.",
    ShelfNavInstructionPressSpace: "Press Space to create a type-in pill.",
    ...
    ToolbarCustomViewsErrorAlreadyExists: "A custom view with that name already exists in this workbook.",
    ...
    ToolbarSessionOfflineServerError: "The request could not be completed. Reconnect and try again.",
